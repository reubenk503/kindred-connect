...
<h1 class="reveal font-display-xl text-display-xl-mobile md:text-display-xl uppercase leading-none mb-stack-lg">
...
<h2 class="reveal font-headline-lg text-headline-lg-mobile md:text-headline-lg mb-12 border-b-[3px] border-on-surface pb-4">Direct Inquiry</h2>
...
<button class="w-full md:w-auto bg-primary-container border-[3px] border-on-surface px-6 sm:px-12 py-4 sm:py-5 font-headline-lg text-xl sm:text-2xl brutalist-shadow brutalist-button-hover transition-transform active:translate-y-1" type="submit">
                        SEND DISPATCH
                    </button>
</form>
</div>
...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact & Booking | Csaszar Regulatory Services" },
      { name: "description", content: "Contact & Booking | Csaszar Regulatory Services" },
      { property: "og:title", content: "Contact & Booking | Csaszar Regulatory Services" },
      { property: "og:description", content: "Contact & Booking | Csaszar Regulatory Services" },
    ],
  }),
  component: Page,
});
